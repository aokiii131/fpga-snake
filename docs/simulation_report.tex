...
\begin{figure}[htbp]
    \centering
    % Khi có ảnh thật, thay khung \fbox bằng lệnh: \includegraphics[width=0.9\textwidth]{images/wf_tc01_reset.png}
...
\section{Kết quả Mô phỏng Module Button Conditioner (Chờ bổ sung)}

\section{Kết quả Mô phỏng Module Tick Generator (Chờ bổ sung)}
